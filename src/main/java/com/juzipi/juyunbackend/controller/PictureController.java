...
import com.juzipi.juyunbackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.juzipi.juyunbackend.api.imagesearch.ImageSearchApiFacade;
...
import com.juzipi.juyunbackend.domain.enums.PictureReviewStatusEnum;
import com.juzipi.juyunbackend.domain.vo.PictureTagCategory;
...
import com.juzipi.juyunbackend.manage.auth.annotation.SaSpaceCheckPermission;
import com.juzipi.juyunbackend.manage.auth.model.SpaceUserPermissionConstant;
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = String.format("jupicture:listPictureVOByPage:%s", hashKey);
        // 1. 先从本地缓存中查询
