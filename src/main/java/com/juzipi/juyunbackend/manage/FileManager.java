package com.juzipi.juyunbackend.manage;
...
import com.juzipi.juyunbackend.config.CosClientConfig;
...
public class FileManager {
    ...
    public UploadPictureResult uploadPicture(MultipartFile multipartFile, String uploadPathPrefix) {
        ...
        String uploadPath = String.format("%s%s", uploadFilename, originalFilename);
        File file = null;
        try {
            //创建临时文件
